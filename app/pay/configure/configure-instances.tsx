                        ...
                        <div className="rounded-xl border-2 border-dashed border-[var(--accent)] bg-[var(--accent-soft)]/20 p-3">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    type="button"
                                    onClick={() =>
                                        setPaymentTypes([...paymentTypes, { name: "", description: "", amount: "" }])
                                    }
                                    className="text-xs font-semibold text-[var(--accent)] transition hover:underline"
                                >
                                    + Add Type
                            ...
                            <p className="mt-1 text-xs text-[var(--muted-foreground)]">
                                Define specific reasons and fixed amounts operators will select from.
                            </p>

                            <div className="mt-3 space-y-2">
                                {paymentTypes.map((pt, index) => (
                                    <div key={index} className="space-y-1 rounded-lg bg-[var(--surface)] p-2">
                                        <div className="flex gap-2">
                                            <input
                                                value={pt.name}
                                                onChange={(e) => {
                                                ...
                                                className="h-10 flex-1 rounded-xl border border-[var(--border)] bg-[var(--surface)] px-3 text-sm text-[var(--foreground)] outline-none focus:border-[var(--accent)]"
                                                required
                                            />
                                            <input
                                                value={pt.amount}
                                                ...
                                                step="0.01"
                                                placeholder="Amount"
                                                className="h-10 w-28 rounded-xl border border-[var(--border)] bg-[var(--surface)] px-3 text-sm text-[var(--foreground)] outline-none focus:border-[var(--accent)]"
                                                required
                                            />
                                            <button
                                                type="button"
                                        ...
                                        <input
                                            ...
                                            className="h-9 w-full rounded-xl border border-[var(--border)] bg-[var(--surface)] px-3 text-xs text-[var(--foreground)] outline-none focus:border-[var(--accent)]"
                                        />
                                    </div>
                                ))}
